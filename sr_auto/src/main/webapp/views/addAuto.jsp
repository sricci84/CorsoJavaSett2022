...
<form:form action="addAuto" modelAttribute="automobile" method="POST">
  <div class="form-row">
    <div class="form-group col-md-4">
      <label for="inputTarga">Targa</label>
      <form:input id="targa" path="targa" cssClass="form-control"/>
       </div>
      <div class="form-group col-md-4">
      <label for="inputCostruttore">Costruttore</label>
      <br>
      <form:select path="costruttore" class="form-select">
				    	<form:options items="${costruttore}" />
					</form:select>
					 </div>
		<div class="form-group col-md-4">			
		<label for="inputModello">Modello</label>
      <form:input id="modello" path="modello" cssClass="form-control"/>
       		</div>
        </div>
        <div class="form-row">
    		<div class="form-group col-md-3">
      <label for="inputAlimentazione">Alimentazione</label>
    <form:select path="alimentazione" class="form-select">
				    	<form:options items="${alimentazione}" />
					</form:select>
					</div>
					<div class="form-group col-md-3">
		<label for="inputAnnoCostruzione">AnnoCostruzione</label>
       <form:input id="annoCostruzione" path="AnnoCostruzione" cssClass="form-control"/>
       </div>
					<div class="form-group col-md-3">
					<label for="inputColore">Colore</label>
					<br>
        <form:select path="colore" class="form-select">
				    	<form:options items="${colore}" />
					</form:select>
					</div>
					<div class="form-group col-md-3">
		<label for="inputCosto">Costo</label>			
      <form:input id="costo" path="costo" cssClass="form-control"/>
    </div>
